...
urlpatterns = [
    ...
    path('purchase_success/<int:seat_number>/<int:price>/<int:session_id>/', views.purchase_success, name='success_url'),
    ...
    path('accounts/password_reset/s', auth_views.PasswordResetView.as_view(), name='password_reset'),
